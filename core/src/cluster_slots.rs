use {
    ...
    nexis_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    nexis_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, nexis_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = nexis_sdk::pubkey::new_rand();
        let k2 = nexis_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.id = nexis_sdk::pubkey::new_rand();
        }
        let slot = 9;
