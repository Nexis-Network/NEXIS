...
pub mod rpc_accounts {
    ...
    impl AccountsData for AccountsDataImpl {
        ...
        fn get_nexis_accounts_by_owner_key(
            ...
            let accounts = meta.get_nexis_accounts_by_owner_key(&bank, owner_key).transpose().map_err(|e|RpcCustomError::ScanError {
                message: e.to_string(),
            })?;
            debug!(
        ...
        fn get_nexis_relying_parties_by_owner_key(
            ...
            let accounts = meta.get_nexis_relying_party_by_owner_key(&bank, owner_key).transpose().map_err(|e|RpcCustomError::ScanError {
                message: e.to_string(),
            })?;
            debug!(
        ...
        fn get_nexis_accounts_by_operational_key(
            ...
            let storages =
                meta.get_nexis_accounts_storages_by_operational_key(&bank, operational_key).transpose().map_err(|e|RpcCustomError::ScanError {
                    message: e.to_string(),
                })?;
            debug!(
