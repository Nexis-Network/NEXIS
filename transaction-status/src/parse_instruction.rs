use {
    ...
    inflector::Inflector,
    serde_json::Value,
    nexis_account_decoder::parse_token::spl_token_ids,
    nexis_sdk::{instruction::CompiledInstruction, pubkey::Pubkey, stake, system_program},
    std::{
        collections::HashMap,
...
lazy_static! {
    ...
    static ref BPF_LOADER_PROGRAM_ID: Pubkey = nexis_sdk::bpf_loader::id();
    ...
    static ref EVM_PROGRAM_ID: Pubkey = nexis_evm_loader_program::ID;
