...
default_arg --rpc-bind-address 0.0.0.0
default_arg --rpc-port 8899
default_arg --gossip-host 0.0.0.0
default_arg --gossip-port 8001
default_arg --log -
default_arg --enable-cpi-and-log-storage
default_arg --enable-rpc-transaction-history
default_arg --rpc-pubsub-enable-block-subscription
default_arg --rpc-pubsub-enable-vote-subscription
default_arg --evm-state-archive "$ledger_dir"/evm-state-archive
default_arg --evm-state "$ledger_dir"/evm-state
#default_arg --init-complete-file "$ledger_dir"/blockchain-is-synced
