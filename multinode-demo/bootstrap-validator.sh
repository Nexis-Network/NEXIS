...
identity=$NZT_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$NZT_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$NZT_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
