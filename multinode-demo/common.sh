...
nexis_bench_tps=$(nexis_program bench-tps)
nexis_faucet=$(nexis_program faucet solana)
nexis_validator=$(nexis_program validator)
nexis_validator_cuda="$nexis_validator --cuda"
nexis_genesis=$(nexis_program genesis solana)
nexis_gossip=$(nexis_program gossip)
nexis_keygen=$(nexis_program keygen)
nexis_ledger_tool=$(nexis_program ledger-tool)
nexis_cli=$(nexis_program)
