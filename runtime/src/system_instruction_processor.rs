...
pub fn process_instruction(
    ...
    match instruction {
        ...
        SystemInstruction::AdvanceNonceAccount => {
            ...
            #[allow(deprecated)]
            if from_keyed_account::<nexis_sdk::sysvar::recent_blockhashes::RecentBlockhashes>(
        ...
        SystemInstruction::WithdrawNonceAccount(lamports) => {
            ...
            #[allow(deprecated)]
            let _ = from_keyed_account::<nexis_sdk::sysvar::recent_blockhashes::RecentBlockhashes>(
...
mod tests {
    ...
    use {
        ...
        bincode::serialize,
        nexis_program_runtime::invoke_context::{mock_process_instruction, InvokeContext},
    ...
    fn test_process_nonce_ix_ok() {
        ...
        let new_recent_blockhashes_account = Rc::new(RefCell::new(
            nexis_sdk::recent_blockhashes_account::create_account_with_data_for_test(
