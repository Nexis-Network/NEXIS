...
use nexis_sdk::pubkey::{Pubkey, PUBKEY_BYTES};

nexis_sdk::declare_id!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");

pub(crate) mod new_token_program {
    nexis_sdk::declare_id!("nTok2oJvx1CgbYA2SznfJLmnKLEL6sYdh2ypZms2nhm");
}
...
pub mod native_mint {
    nexis_sdk::declare_id!("So11111111111111111111111111111111111111112");
