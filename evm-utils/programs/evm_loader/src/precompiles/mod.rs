...
pub fn entrypoint(
    ...
    let precompiles = match activate_precompile {
        PrecompileSet::NexisClassic => &PRECOMPILES_MAP_DEPRECATED,
        PrecompileSet::NexisNext => &PRECOMPILES_MAP,
...
mod test {
    ...
    fn call_to_sha256() {
        ...
        AccountStructure::testing(0, |accounts: AccountStructure| {
            let precompiles = entrypoint(accounts, PrecompileSet::NexisClassic, false);
            let input = [0u8; 0];
    ...
    fn call_modexp() {
        ...
        // // this test is slow
        // AccountStructure::testing(0, |accounts| {
        //     let precompiles = entrypoint(accounts, ActivatePrecompile::NexisNext);
        //     let input = hex!(
        //         "
        ...
        AccountStructure::testing(0, |accounts| {
            let precompiles = entrypoint(accounts, PrecompileSet::NexisNext, false);
            let input = hex!(
                "
