use {
    ...
    bincode::deserialize,
    serde_json::Value,
    nexis_config_program::{get_config_data, ConfigKeys},
    nexis_sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        ...
        nexis_config_program::create_config_account, nexis_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = nexis_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Nexis"}"#).unwrap(),
            }),
        );
