...
pub enum LedgerError {
    #[error("Nexis app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Nexis message")]
    NexisInvalidMessage = 0x6a80,

    #[error("Nexis summary finalization failed on Ledger device")]
    NexisSummaryFinalizeFailed = 0x6f00,

    #[error("Nexis summary update failed on Ledger device")]
    NexisSummaryUpdateFailed = 0x6f01,
