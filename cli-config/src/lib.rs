...
//!   the documentation for `nexis_clap_utils::keypair::signer_from_path`.
//!
...
//! ```no_run
//! use anyhow::anyhow;
//! use nexis_cli_config::{CONFIG_FILE, Config};
//!
//! let config_file = nexis_cli_config::CONFIG_FILE.as_ref()
//!     .ok_or_else(|| anyhow!("unable to get config file path"))?;
//! let mut cli_config = Config::load(&config_file)?;
//! // Set the RPC URL to devnet
//! cli_config.json_rpc_url = "https://api.devnet.nexis.network".to_string();
