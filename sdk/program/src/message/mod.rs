...
//!
//! In Nexis, programs execute instructions, and clients submit sequences
//! of instructions to the network to be atomically executed as [`Transaction`]s.
//!
//! [`Transaction`]: https://docs.rs/nexis-sdk/latest/nexis-sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://docs.nexis.network/developing/programming-model/transactions#recent-blockhash
//!
...
//! version as of Nexis 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! Despite living in the `nexis-program` crate, there is no way to access the
//! runtime's messages from within a Nexis program, and only the legacy message
//! types continue to be exposed to Nexis programs, for backwards compatibility
//! reasons.
...
///
/// [PoH]: https://docs.nexis.network/cluster/synchronization
