//! Nexis Rust-based BPF program entry point supported by the latest
...
/// errors. To avoid this, it is common for Nexis programs to define an
...
/// [BPF]: https://docs.nexis.network/developing/on-chain-programs/overview#berkeley-packet-filter-bpf
///
/// # Cargo features
///
...
///
/// # Defining a panic handler for Nexis
///
/// _The mechanism for defining a Nexis panic handler is different [from most
...
/// ```
///
/// The above is how Nexis defines the default panic handler.
#[macro_export]
