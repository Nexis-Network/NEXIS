#pragma once
/**
 * @brief Nexis Cross-Program Invocation
 */
 ...
 */
static uint64_t nzt_invoke_signed(
    const SolInstruction *instruction,
    const SolAccountInfo *account_infos,
    int account_infos_len,
    const SolSignerSeeds *signers_seeds,
 ...
 * @param account_infos_len Length of account_infos array
*/
static uint64_t nzt_invoke(
    const SolInstruction *instruction,
    const SolAccountInfo *account_infos,
    int account_infos_len
) {
  const SolSignerSeeds signers_seeds[] = {{}};
  return nzt_invoke_signed(
    instruction,
    account_infos,
    account_infos_len,
    signers_seeds,
