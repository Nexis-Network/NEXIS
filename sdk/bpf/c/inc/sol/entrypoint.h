#pragma once
/**
 * @brief Nexis program entrypoint
 */
...
/**
 * The Nexis runtime provides a memory region that is available to programs at
 * a fixed virtual address and length. The builtin functions `nzt_calloc` and
 * `nzt_free` call into the Nexis runtime to allocate from this memory region
 ...
 *
 * @param input Buffer of serialized input parameters.  Use nzt_deserialize() to decode
