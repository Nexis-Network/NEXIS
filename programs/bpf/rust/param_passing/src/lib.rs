...
use nexis_bpf_rust_param_passing_dep::{Data, TestDep};
use nexis_program::{custom_panic_default, entrypoint::SUCCESS, log::nzt_log_64};
...
pub extern "C" fn entrypoint(_input: *mut u8) -> u64 {
    ...
    nzt_log_64(0, 0, 0, 0, test_dep.thirty as u64);
