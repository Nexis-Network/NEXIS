...
{ # this ensures the entire script is downloaded #
    ...
    if [ -z "$SOLANA_DOWNLOAD_ROOT" ]; then
        SOLANA_DOWNLOAD_ROOT="https://github.com/Nexis-Network/NEXIS/releases/download/"
    fi
    GH_LATEST_RELEASE="https://api.github.com/repos/Nexis-Network/NEXIS/releases/latest"
