...
impl SnapshotHashes {
    ...
    pub(crate) fn new_rand<R: Rng>(rng: &mut R, pubkey: Option<Pubkey>) -> Self {
        ...
        let hashes = std::iter::repeat_with(|| {
            ...
            let hash = nexis_sdk::hash::new_rand(rng);
            (slot, hash)
        })
        .take(num_hashes)
        .collect();
...
pub struct LegacyVersion {
    pub from: Pubkey,
    pub wallclock: u64,
    pub version: nexis_version::LegacyVersion,
}
...
pub struct Version {
    pub from: Pubkey,
    pub wallclock: u64,
    pub version: nexis_version::Version,
}
...
impl Version {
    pub fn new(from: Pubkey) -> Self {
        Self {
            from,
            wallclock: timestamp(),
            version: nexis_version::Version::default(),
        }
    }
...
mod test {
    use {
        ...
        nexis_vote_program::{vote_instruction, vote_state},
