...
cat >/etc/apt/apt.conf.d/99-nexis<<'EOF'
...
"$NZT_ROOT"/net/scripts/install-docker.sh
usermod -aG docker "$SETUP_USER"
"$NZT_ROOT"/net/scripts/install-certbot.sh
...
"$NZT_ROOT"/net/scripts/install-earlyoom.sh
"$NZT_ROOT"/net/scripts/install-nodejs.sh
"$NZT_ROOT"/net/scripts/localtime.sh
"$NZT_ROOT"/net/scripts/install-redis.sh
"$NZT_ROOT"/net/scripts/install-rsync.sh
"$NZT_ROOT"/net/scripts/install-libssl-compatability.sh
